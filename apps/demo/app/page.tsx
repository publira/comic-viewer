    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        <section className={styles.description}>
          ...
          <p>
            Each page uses a normal JPEG URL together with its own
            low-resolution placeholder. The viewer displays the muted, blurred
            placeholder while the full image is loading.
          </p>
        </section>
      </div>
    </main>
