...
/**
 * A comic reader styled with Tailwind utilities alone: this demo composes the
 * public viewer primitives and never imports
 * `@publira/comic-viewer/default.css`. Nothing here is decoration — the rail
 * turns pages because of `w-[300%]` and the `translateX(…)` transforms, and the
 * toolbar and the navigation hide through `aria-hidden:opacity-0`.
 */
export const Reader = ({ pages }: ReaderProps) => (
  <ComicViewer.Root
